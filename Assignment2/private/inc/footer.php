...
/*
    footer.php
    This php file contains php code that defines the footer for all pages of this website.
*/
?>
...
<footer>
    <div class="footer">
        <div class="footer-logo">
            ...
            <span class="footer-logo-text">WebProgramazon.ca</span>
        </div>
        <span class="last-updated">Last Updated: March 27, 2024</span>
    </div>
</footer>
</body>
